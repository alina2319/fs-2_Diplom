    ...
    <section class="conf-step" id="Halls_Control">
        ...
        <div class="conf-step__wrapper">
            ...
            <div class="popup__wrapper">
                ...
                <a href="{{route('admin_login')}}" style="text-decoration: none"><button class="conf-step__button conf-step__button-regular" name="redirect">Я уже зарегистрирован</button></a>
            </div>            
        </div>
